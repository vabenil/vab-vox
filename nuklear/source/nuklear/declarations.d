...
// NOTE: Taken from bindbc-nuklear
module nuklear.declarations;
...
extern(C) @nogc nothrow {
    ...
    // LIB stuff
    void nk_widget_text(nk_command_buffer *o, nk_rect b, const(char)* str, int len, const(nk_text_style)* t, nk_flags a, const(nk_user_font)* f);
    void nk_widget_text_wrap(nk_command_buffer *o, nk_rect b, const(char)* str, int len, const(nk_text_style)* t, const(nk_user_font)* f);
